...
function pilihElement(elm) {
    switch (elm) {
        ...
        case 'button': {
            rendElm({
                to: "#modalBody", elm: [
                    {elm:"input", name:"elm", value:"BUTTON", type:"hidden"},
                    {elm: "div", cls: "form-group", elms: [
                        {elm: "label", text: "Jenis" },
                    ...
                    {elm: "div", cls: "form-group", elms: [
                        { elm: "label", text: "Class" },
                        { elm: "input", type: "text", id: "edtCls", name:"cls", cls: "form-control", value: "btn btn-primary" },
                    ]},
                    {elm: "div", cls: "form-group", elms: [
                        { elm: "label", text: "Style" },
                        { elm: "input", type: "text", id: "edtStyle", name:"style", cls: "form-control cls-input" },
        ...
        case 'grid': {
            rendElm({
                to: "#modalBody", elm: [
                    {elm:"input", type:"hidden", name:"elm", cls:"cls-input", value:"grid"},
                    {elm: "div", cls: "form-group", elms: [
                        {elm: "label", text: "Jumlah Grid" },
                        {elm: "select", id: "edtJumlah", name:"arr", cls: "form-select cls-input", elms: [
        ...
        case 'table': {
            rendElm({
                to: "#modalBody", elm: [
                    {elm:"input", type:"hidden", cls:"cls-input", name:"elm", value:"table"},
                    {elm: "div", cls: "form-group", elms: [
                        { elm: "label", text: "ID" },
                        { elm: "input", type: "text", id: "edtID", name:"id", cls: "form-control cls-input" },
                    ]},
                    {elm: "div", cls: "form-group", elms: [
                        { elm: "label", text: "Class" },
                        { elm: "input", type: "text", id: "edtCls", name:"cls", cls: "form-control cls-input", value: "table table-striped" },
                    ]},
                    {elm: "div", cls: "row", elms: [
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Jumlah Row" },
                                { elm: "input", type: "number", cls: "form-control cls-input", id: "edtRow", name:"row", value: "0", required: true },
                        ...
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                ...
                                { elm: "input", type: "number", cls: "form-control cls-input", id: "edtCell", name:"cell", value: "0", required: true },
        ...
        case 'input': {
            rendElm({
                to: "#modalBody", elm: [
                    {elm:"input", type:"hidden", name:"elm", value:"input"},
                    {elm: "div", cls: "form-group", elms: [
                        {elm: "label", text: "Jenis" },
                        {elm: "select", id: "edtType", name:"type", cls: "form-select cls-input", elms: [
                    ...
                    {elm: "div", cls: "form-group", elms: [
                        ...
                        { elm: "input", type: "text", id: "edtLabel", name:"label", cls: "form-control cls-input", required: true },
                    ...
                    {elm: "div", cls: "row", elms: [
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                ...
                                { elm: "input", type: "text", id: "edtValue", name:"value", cls: "form-control cls-input" }
                            ]},
                        ]},
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Name" },
                                { elm: "input", type: "text", id: "edtName", name:"name", cls: "form-control cls-input", required: true },
                    ...
                    {elm: "div", cls: "row", elms: [
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Max" },
                                { elm: "input", type: "number", id: "edtMax", name:"max", cls: "form-control cls-input", disabled: true }
                            ]},
                        ]},
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Min" },
                                { elm: "input", type: "number", id: "edtMin", name:"min", cls: "form-control cls-input", disabled: true }
                            ]},
                        ]},
                    ]},
                    {elm: "div", cls: "row", elms: [
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                ...
                                { elm: "input", type: "number", id: "edtMaxLength", name:"maxlength", cls: "form-control cls-input" }
                            ]},
                        ]},
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Min Length" },
                                { elm: "input", type: "number", id: "edtMinLength", name:"minlength", cls: "form-control cls-input" }
                            ]},
                        ]},
                    ]},
                    {elm: "div", cls: "row", elms: [
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                ...
                                { elm: "input", type: "text", id: "edtPlaceholder", name:"placeholder", cls: "form-control cls-input" }
                            ]},
                        ]},
                        {elm: "div", cls: "col-md-6 mb-2", elms: [
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Required" },
                                { elm: "input", type: "text", id: "edtRequired", name:"required", cls: "form-control cls-input" }
                            ]},
                        ]},
                    ]},
                    {elm: "div", cls: "form-group", elms: [
                    ...
                    {elm: "div", cls: "form-group", elms: [
                        { elm: "label", text: "Class" },
                        { elm: "input", type: "text", id: "edtCls", name:"cls", cls: "form-control cls-input", value: "form-control" },
                    ]},
                ]
            });
        ...
        case 'select':{
            rendElm({
                to: "#modalBody", elm: [
                    {elm:"input", type:"hidden", name:"elm", cls:"cls-input", value:"select"},
                    {elm: "div", cls: "form-group", elms: [
                        { elm: "label", text: "Label" },
                        { elm: "input", type: "text", id: "edtLabel", name:"label", cls: "form-control cls-input" },
                    ]},
                    {elm:"div", cls:"row", elms:[
                        {elm:"div", cls:"col-md-6 mb-2", elms:[
                            {elm: "div", cls: "form-group", elms: [
                        ...
                        {elm:"div", cls:"col-md-6 mb-2", elms:[
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Class" },
                                { elm: "input", type: "text", id: "edtClass", name:"cls", cls: "form-control cls-input", value:"form-select" },
                            ]},
                        ]},
                    ]},
                    {elm: "div", cls: "form-group", elms: [
        ...
        case 'textarea':{
            rendElm({
                to: "#modalBody", elm: [
                    {elm:"input", type:"hidden", name:"elm", cls:"cls-input", value:"tetxtarea"},
                    {elm: "div", cls: "form-group", elms: [
                        { elm: "label", text: "Label" },
                        { elm: "input", type: "text", id: "edtLabel", name:"label", cls: "form-control cls-input" },
                    ]},
                    ...
                    {elm:"div", cls:"row", elms:[
                        {elm:"div", cls:"col-md-6 mb-2", elms:[
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Row" },
                                { elm: "input", type: "number", id: "edtID", name:"rows", cls: "form-control cls-input", value:"4" },
                            ]},
                        ]},
                        {elm:"div", cls:"col-md-6 mb-2", elms:[
                            {elm: "div", cls: "form-group", elms: [
                                { elm: "label", text: "Cols" },
                                { elm: "input", type: "number", id: "edtClass", name:"cols", cls: "form-control cls-input", value:"50" },
                            ]},
                        ]},
                    ]},
                    {elm: "div", cls: "row", elms: [
...
function editElement(e) {
    ...
    elmToRend.push({ elm:"div", cls:"d-flex", elms:[
        ...
        {elm: "button", type: "button", onclick:"__handleHapusElement()", cls: "btn btn-danger", text: "Hapus"}
    ] });
...
function __handleAddElm(e) {
    ...
    if (e.target.checkValidity()) {
        ...
        for (let i = 0; i < input.length; i++) {
            if(input[i].name) tempELm[input[i].name] = input[i].value;
        }
        ...
        to: "#tbodyElement", elm: [
            {elm: "table", cls: "table table-striped table-hovered", elms: [
                {elm: "tbody", elms: [
                    ...
                    {elm: "tr", onclick: "pilihElement('select')", elms: [
                        { elm: "td", text: "Dropdown" }
                    ] },
                    {elm: "tr", onclick: "pilihElement('textarea')", elms: [
                        { elm: "td", text: "Textarea" }
                    ] },
